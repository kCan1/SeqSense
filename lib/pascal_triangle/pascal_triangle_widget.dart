...
export 'pascal_triangle_model.dart';

class PascalTriangleWidget extends StatefulWidget {
  const PascalTriangleWidget({super.key});

  static String routeName = 'PascalTriangle';
  static String routePath = '/pascalTriangle';
...
class _PascalTriangleWidgetState extends State<PascalTriangleWidget> {
  late PascalTriangleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PascalTriangleModel());
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'The Pascal Triangle is a triangular array where each number is the sum of the two numbers directly above it, starting with a single 1 at the top.',
                    ...
                    child: Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              if (functions.checkNumberEqualzero(
                                ...
                                _model.answer = await actions.calcPascal(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Kindly input a number greater than 0.',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryText,
                                      ),
